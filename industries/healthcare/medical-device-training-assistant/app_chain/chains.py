...
from src.chain_server.base import BaseExample
from src.chain_server.tracing import langchain_instrumentation_class_wrapper

# pylint: disable=no-name-in-module, disable=import-error
from src.chain_server.utils import (
...
class MultiTurnChatbot(BaseExample):
    ...
    def rag_chain(self, query: str, chat_history: List["Message"], **kwargs) -> Generator[str, None, None]:
        ...
        #     [
        #         ("system", settings.prompts.app_chain_template),
        #         ("user", "{input}"),
        #     ]
        # )
